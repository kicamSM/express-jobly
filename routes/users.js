...
router.post("/:username/jobs/:id", ensureUsersAccountOrAdmin, async function (req, res, next) {
  try {
...
router.patch("/:username", ensureUsersAccountOrAdmin, async function (req, res, next) {
  try {
...
router.delete("/:username", ensureUsersAccountOrAdmin, async function (req, res, next) {
  try {
